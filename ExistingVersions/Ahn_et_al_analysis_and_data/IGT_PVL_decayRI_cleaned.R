# IGT_PVL_decayRI.R
# PVL model with decay-RI learning rule (Ahn et al., 2008, Cog Sci; 2011, JNPE)
...
#-----------------------------------------------------------------------------#
saveDir = "~/Documents/myDirectory/subMyDirectory/PVL_decayRI/" # working directory where all codes should exist 
...
modelName = "PVL_decayRI"    #"3par_PT_softmax" or "3par_PT_DFT"
...
# Compute WAIC
if (computeWAIC) {
  source("WAIC_PVL_decayRI_cleaned.R")
}
