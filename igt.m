...
%todo
%impose ITI of 3s (e.g., Nejtek et al PsychiatryResearch 2013)
%load our payoff matrix
%determine whether 
% at bottom:
% Reward
% Panelty
% Net Gain 
% list total at side and track total
% start at 2000
% color bar at bottom
...
[wPtr,wRect] = Screen('OpenWindow',0, [], screenRect);
w = wRect(RectRight);
h = wRect(RectBottom);
